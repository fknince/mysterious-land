            ...
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle ">
                  <span className="theme-gradient">FİYATLANDIRMA</span>
                </h4>
                <h2 className="title w-600 mb--20">İhtiyacınız Kadar Ödeyin</h2>
                <p className="description b1">
                  Genom, her bütçeye uygun çözümler sunar. İhtiyacınıza uygun
                  paketi seçin ve hemen kullanmaya başlayın.
                </p>
              </div>
            </div>
          </div>
